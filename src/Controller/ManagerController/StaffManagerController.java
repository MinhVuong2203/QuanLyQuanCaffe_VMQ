...
import View.ManagerView.ManagerStaff.RequestDialog;
    ...
    public void actionPerformed(java.awt.event.ActionEvent e) {
        ...
        if (command.equalsIgnoreCase("Thêm")) {
            ...
            try {
                ...
                addEmployeeJDialog = new AddOrFixEmployeeJDialog("update",
                        this.staffManagerJPanel.getEmployeeSelected(), staffManagerJPanel);
                addEmployeeJDialog.setVisible(true);
            ...
            try {
                System.out
                        .println("Đang cho nhân nghỉ việc nhân viên: " + this.staffManagerJPanel.getEmployeeSelected());
                JOptionPane.showConfirmDialog(staffManagerJPanel,
                        "Bạn có chắc chắn muốn nghỉ việc nhân viên này không?", "Xác nhận", JOptionPane.YES_NO_OPTION);
                if (JOptionPane.YES_OPTION == 0) {
                    ...
                    if (employeeService.quitJob(this.staffManagerJPanel.getEmployeeSelected().getId())) {
                        ...
                        JOptionPane.showMessageDialog(staffManagerJPanel, "Nghỉ việc nhân viên thành công",
                                "Thành công", JOptionPane.INFORMATION_MESSAGE);
                    } else {
                        JOptionPane.showMessageDialog(staffManagerJPanel, "Không thể nghỉ việc nhân viên này!", "Lỗi",
